...
static ZKWindow* mdock3WindowPtr;
static ZKWindow* mdock2WindowPtr;
static ZKWindow* mdock1WindowPtr;
static ZKPageWindow* mdockPageWindowPtr;
static ZKTextView* mpage1AirPlayTextViewPtr;
static ZKTextView* mpage2AiCastTextViewPtr;
static ZKTextView* mpage1MiracastTextViewPtr;
static ZKTextView* mpage3AlbumTextViewPtr;
static ZKTextView* mpage2VideoTextViewPtr;
static ZKTextView* mpage3PictureTextViewPtr;
static ZKTextView* mpage1AndroidAutoTextViewPtr;
static ZKTextView* mpage2AudiooutputTextViewPtr;
static ZKTextView* mpage1CarPlayTextViewPtr;
static ZKTextView* mpage1BluetoothTextViewPtr;
...
static S_SlideWindowItemClickCallback SSlideWindowItemClickCallbackTab[] = {
    ID_MAIN_appSlideWindow, onSlideItemClick_appSlideWindow,
};
...
mainActivity::~mainActivity() {
  ...
  // 退出应用时需要反注册
    ...
    onUI_quit();
    mActivityPtr = NULL;
    mdock3WindowPtr = NULL;
    mdock2WindowPtr = NULL;
    mdock1WindowPtr = NULL;
    mdockPageWindowPtr = NULL;
    mpage1AirPlayTextViewPtr = NULL;
    mpage2AiCastTextViewPtr = NULL;
    mpage1MiracastTextViewPtr = NULL;
    mpage3AlbumTextViewPtr = NULL;
    mpage2VideoTextViewPtr = NULL;
    mpage3PictureTextViewPtr = NULL;
    mpage1AndroidAutoTextViewPtr = NULL;
    mpage2AudiooutputTextViewPtr = NULL;
    mpage1CarPlayTextViewPtr = NULL;
    mpage1BluetoothTextViewPtr = NULL;
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mdock3WindowPtr = (ZKWindow*)findControlByID(ID_MAIN_dock3Window);
    mdock2WindowPtr = (ZKWindow*)findControlByID(ID_MAIN_dock2Window);
    mdock1WindowPtr = (ZKWindow*)findControlByID(ID_MAIN_dock1Window);
    mdockPageWindowPtr = (ZKPageWindow*)findControlByID(ID_MAIN_dockPageWindow);
    mpage1AirPlayTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_page1AirPlayTextView);
    mpage2AiCastTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_page2AiCastTextView);
    mpage1MiracastTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_page1MiracastTextView);
    mpage3AlbumTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_page3AlbumTextView);
    mpage2VideoTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_page2VideoTextView);
    mpage3PictureTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_page3PictureTextView);
    mpage1AndroidAutoTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_page1AndroidAutoTextView);
    mpage2AudiooutputTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_page2AudiooutputTextView);
    mpage1CarPlayTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_page1CarPlayTextView);
    mpage1BluetoothTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_page1BluetoothTextView);
    mappSlideWindowPtr = (ZKSlideWindow*)findControlByID(ID_MAIN_appSlideWindow);if(mappSlideWindowPtr!= NULL){mappSlideWindowPtr->setSlideItemClickListener(this);}
